...
public class AlumnoController {
	...
	public String nuevoPost(@Valid @ModelAttribute("alumno") AlumnoForm form,Model model ,BindingResult result)
	...
	public String modificar(@RequestParam("id") Long id, Model model) throws ServiceException, DaoException {
		...
		if (id == null) {
			...
			if (alumno != null) {
					ResponsableAlumno a=alumno.getResponsableAlumno();
					
						List<ResponsableAlumno> listado = this.responsableService.buscarTodos();
						model.addAttribute("listado", listado); 
					
					AlumnoForm form = new AlumnoForm(alumno);
					form.setResponsable(a);
	...
	public String modificarPost(@ModelAttribute("formulario") AlumnoForm alumno, Model model, BindingResult result)
			throws ServiceException, DaoException {
